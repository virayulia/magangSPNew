...
<head>
    <meta charset="UTF-8">
    <title>Reminder Penetapan Pembimbing Penelitian</title>
</head>
<body style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #333; line-height: 1.6;">
    ...
    <p>
        Bersama email ini kami sampaikan <strong>pengingat penetapan Pembimbing Penelitian</strong>
        untuk peserta penelitian yang telah diterima dan sedang melaksanakan kegiatan penelitian.
    </p>

    <p>Adapun daftar peserta penelitian pada unit kerja Bapak/Ibu sebagai berikut:</p>
    ...
    <p>
        Untuk mendukung kelancaran pelaksanaan penelitian, kami mohon kiranya
        <strong>Pembimbing Penelitian</strong> dapat segera ditetapkan melalui sistem.
        Pembimbing tersebut akan berperan sebagai pendamping serta penghubung utama
        selama proses penelitian berlangsung.
    </p>

    <p style="text-align: center; margin: 25px 0;">
        <a href="<?= base_url('pembimbing/peserta-penelitian'); ?>"
           style="
                ...
                font-weight: bold;
           ">
            Tetapkan Pembimbing Penelitian
        </a>
    </p>
