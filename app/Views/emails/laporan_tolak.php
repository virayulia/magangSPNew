...
<head>
    <meta charset="UTF-8">
    <title>Penolakan Laporan Magang</title>
</head>
<body style="font-family: Arial, sans-serif; color: #333;">
    ...
    <p>
    Bersama email ini kami informasikan bahwa laporan magang Anda <strong>belum memenuhi kelengkapan atau validitas yang disyaratkan</strong>.
    </p>
    ...
    <p>
    Silahkan menguggah ulang laporan Anda dengan benar.
    </p>

    <p>
    Untuk memperbarui laporan, silakan klik tombol di bawah ini:
    </p>
