...
<div class="profile-card">
    ...
    <p class="text-muted">Lanjutkan proses pelaksanaan penelitian kamu di sini.</p>
    <hr>
    <?php if (!empty($pendaftaran)): ?>
        <?php if ($pendaftaran['status_akhir'] === 'penelitian' || $pendaftaran['status_akhir'] === 'lulus'): ?>
        <div class="tab-content" id="lamaranTabContent">
            <div class="tab-pane fade show active" id="pelaksanaan" role="tabpanel">
                <p class="text-muted">Panduan dan tugas penting yang perlu kamu selesaikan sebelum memulai penelitian:</p>
                    ...
                    <div class="card-body">
                        ...
                        <?php if (!empty($user_data->bpjs_tk) && !empty($user_data->buktibpjs_tk)): ?>
                            <div class="alert alert-success p-4 text-center">
                                ...
                                Kamu telah melengkapi <strong>Berkas Penelitian</strong>. <br><br>
                        ...
                        <?php else: ?>
                            ...
                            <?php endif; ?>
                            <p>Silakan unggah berkas berikut sebelum memulai penelitian:</p>
                            <ul>
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p>Tanda pengenal wajib dicetak dan dibawa saat hari pertama penelitian.</p>
                        ...
                        <?php if (!empty($user_data->bpjs_tk) && !empty($user_data->buktibpjs_tk)): ?>
                            ...
                            <a href="<?= base_url('penelitian/cetak-tanda-pengenal/' . $pendaftaran['penelitian_id']) ?>" 
                    ...
                    <div class="card-body">
                        ...
                        <?php if (!empty($pendaftaran['tanggal_setujui_pernyataan'])): ?>
                            ...
                            <div class="alert alert-success p-4 text-center">
                                ...
                                <a href="<?= base_url('penelitian/surat-pernyataan') ?>" target="_blank" class="btn btn-outline-success">
                        ...
                        <?php elseif (!empty($user_data->bpjs_tk) && !empty($user_data->buktibpjs_tk)): ?>
                            ...
                            <a href="<?= base_url('penelitian/surat-pernyataan') ?>" class="btn btn-primary">Baca & Setujui Surat Pernyataan</a>
                        <?php else: ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-3 mb-3">
                            ...
                            <?php if (
                                ...
                                <a href="<?= base_url('safety-tesP') ?>" class="btn btn-outline-warning">
                                    🚀 Ikuti Tes Safety Induction
                                </a>
                            <?php else: ?>
                                <button class="btn btn-secondary" disabled>Ikuti Tes Safety Induction</button>
                                <div class="alert alert-secondary mt-2">
                                    ⚠️ Tes dapat diikuti pada <strong>hari pertama penelitian mulai 08:30</strong>, 
                ...
                <!-- <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        <h5 class="card-title"> Cetak Lembar Absensi & Formulir Pengambilan Data</h5>
                        <p>Lembar Absensi wajib dicetak dan diisi setiap hari.</p>
                        ...
                        <?php if (!empty($user_data->bpjs_tk) && !empty($user_data->buktibpjs_tk)): ?>
                            ...
                            <?php else: ?>
                                <div class="alert alert-secondary mt-2">⚠️ Menunggu validasi berkas oleh Admin.</div>
                                <button class="btn btn-secondary" disabled>Cetak Lembar Absensi</button>
                            <?php endif; ?>
                        <?php else: ?>
                            <div class="alert alert-secondary mt-2">⚠️ Lengkapi berkas terlebih dahulu.</div>
                            <button class="btn btn-secondary" disabled>Cetak Lembar Absensi</button>
                        ...
                        <?php if (!empty($user_data->bpjs_tk) && !empty($user_data->buktibpjs_tk)): ?>
                            ...
                            <?php else: ?>
                                <div class="alert alert-secondary mt-2">⚠️ Menunggu validasi berkas oleh Admin.</div>
                                <button class="btn btn-secondary" disabled>Cetak Formulir Pengambilan Data</button>
                            <?php endif; ?>
                        <?php else: ?>
                            <div class="alert alert-secondary mt-2">⚠️ Lengkapi berkas terlebih dahulu.</div>
                            <button class="btn btn-secondary" disabled>Cetak Formulir Pengambilan Data</button>
                        ...
                        <?php if ($berkasUser): ?>
                            <?php if ($berkasLengkap): ?>
                                ...
                                <div class="d-flex flex-column gap-2 mt-3">
                                    ...
                                    target="_blank" 
                                    class="btn btn-danger d-flex align-items-center justify-content-center">
                                        <i class="fas fa-file-signature me-2"></i> Cetak Formulir Pengambilan Data
                                    </a>
                                </div>
        ...
        <?php else: ?>
        <div class="alert alert-warning"><i class="fas fa-exclamation-circle me-1"></i> Kamu belum menyelesaikan <strong>Pendaftaran Penelitian</strong>, sehingga belum bisa mengakses informasi pelaksanaan penelitian.</div>
        <?php endif; ?>
    <?php else: ?>
        <div class="alert alert-info text-center">
            Belum Ada Pelaksanaan Penelitian.
        </div>
    <?php endif; ?>
</div>
