...
<div class="profile-card">
                        ...
                        <div class="modal-content">
                            <form action="<?= base_url('unggah-laporan/' . $pendaftaran['magang_id']) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">📄 Laporan (PDF, max 10 MB) <small class="text-danger">*minimal ditandatangani Ka Unit (Band 3)</small></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">🗒️ Absensi (PDF, max 2 MB)</label>
    ...
    <div class="tab-pane fade" id="histori-lamaran" role="tabpanel">
        <p class="text-muted">Riwayat semua laporan yang pernah diunggah.</p>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body d-flex justify-content-between align-items-center flex-wrap">
                            <div class="me-3">
                                ...
                                <p class="text-muted mb-0 small">
                                    <?php if (!empty($riwayat['judul_laporan'])): ?>
                                        Laporan: <?= esc($riwayat['judul_laporan']) ?>
                                    <?php endif; ?>

                                    <?php if (!empty($riwayat['laporan'])): ?>
                                            <a href="<?= base_url('uploads/laporan/' . $riwayat['laporan']) ?>" target="_blank">
                                                Lihat Laporan
                                            </a>
                                    <?php elseif (!empty($riwayat['url_laporan'])): ?>
                                            <a href="<?= esc($riwayat['url_laporan']) ?>" target="_blank">
                                                Lihat Laporan
                                            </a>
                                    <?php endif; ?>
                                    <?php if (!empty($riwayat['absensi'])): ?>
                                            <a href="<?= base_url('uploads/absensi/' . $riwayat['absensi']) ?>" target="_blank">
                                                Lihat Absensi
                                            </a>
                                    <?php elseif (!empty($riwayat['url_absensi'])): ?>
                                            <a href="<?= esc($riwayat['url_absensi']) ?>" target="_blank">
                                                Lihat Absensi
                                            </a>
                                    <?php endif; ?>
                                </p>
