...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-2 text-gray-800">User Manual Aplikasi</h1>
    <p class="mb-4 text-muted">
        Panduan penggunaan aplikasi untuk pengguna
    </p>
...
<div class="modal fade" id="modalTambahChangeLog" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form action="<?= base_url('admin/user-manual/save') ?>" method="post">
            <?= csrf_field() ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <form id="formDeleteChangeLog" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus User Manual ini
