            ...
            <div class="mb-4">
                <div class="row g-3">
                    <div class="col-6 col-md-3">
                        <a href="<?= base_url('admin/penelitian/kelengkapan-berkas') ?>" class="text-decoration-none">
                    ...
                    <div class="col-6 col-md-3">
                        <a href="<?= base_url('admin/penelitian/kelengkapan-berkas?filter=lengkap') ?>" class="text-decoration-none">
                    ...
                    <div class="col-6 col-md-3">
                        <a href="<?= base_url('admin/penelitian/kelengkapan-berkas?filter=tk_bukti_saja') ?>" class="text-decoration-none">
                    ...
                    <div class="col-6 col-md-3">
                        <a href="<?= base_url('admin/penelitian/kelengkapan-berkas?filter=belum') ?>" class="text-decoration-none">
                        ...
                        <?php if (!empty($data)): ?>
                            <?php foreach ($data as $item): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <!-- Form untuk Approve -->
                                        <form action="<?= base_url('admin/penelitian/kelengkapan-berkas/valid/'.$id) ?>" method="post" class="d-inline" onsubmit="return confirmApprove()">
                                            <?= csrf_field() ?>
                                            <button type="submit" class="btn btn-secondary btn-approve" id="approve<?= $id ?>" title="Approve" disabled><i class="fas fa-check-circle"></i></button>
                                        </form>

                                        <!-- Form untuk Tidak Approve -->
                                        <button type="button" class="btn btn-danger" title="Tolak Berkas" data-toggle="modal" data-target="#modalTolak<?= $id ?>">
                                        ...
                                        <div class="modal fade" id="modalTolak<?= $id ?>" tabindex="-1" aria-labelledby="modalTolakLabel<?= $id ?>" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form action="<?= base_url('admin/penelitian/kelengkapan-berkas/tidakValid/'.$id) ?>" method="post">
                                                    <?= csrf_field() ?>
