...
class AuthController extends Controller
{
    ...
    public function attemptRegister()
    {
        ...
        $user_image = $this->_uploadFile('user_image', 'uploads/user-image', $fullname, 'user-image');
        ...
        $suratName = $this->_uploadFile('surat_permohonan', 'uploads/surat-permohonan', $fullname, 'surat-permohonan');
        $ktpName = $this->_uploadFile('ktp_kk', 'uploads/ktp-kk', $fullname, 'ktp-kk');
